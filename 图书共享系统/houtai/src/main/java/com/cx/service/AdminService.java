...
//    boolean register(Admin admin);
    ...
    boolean backBookComplete(String borrowID, String nowTime, Date time);

    String selectShareEndTime(String borrowID, String endTime);

    boolean getBookComplete(String shareID, Date nowTime);
}
